...
const utf8string const RideNames[RIDE_TYPE_COUNT] = {
    "SpiralRollerCoaster",
...
const utf8string const TrackNames[256] = {
    "Flat",
    "EndStation",
    "BeginStation",
    "MiddleStation",
...
const utf8string const FlatTrackNames[256] = {
    "",
    "",
    "",
    "",
...
const utf8string const TrackElemNames[] = {
    "TRACK_ELEM_FLAT",
...
const utf8string const RideCodeNames[RIDE_TYPE_COUNT] = {
    "spiral_rc",
    "stand_up_rc",
...
const utf8string const TrackCodeNames[256] = {
    "flat",
    "end_station",
    "begin_station",
    "middle_station",
