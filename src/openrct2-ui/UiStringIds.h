...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_PLUGIN_MANAGER_TITLE = 7030,
        STR_PLUGIN_NAME = 7031,
        STR_PLUGIN_VERSION_CURRENT = 7032,
        STR_PLUGIN_VERSION_AVAILABLE = 7033,
        STR_PLUGIN_AUTHORS = 7034,
        STR_OPEN_RELEASE_PAGE = 7035,
        STR_OPEN_PLUGIN_DIRECTORY = 7036,
        STR_CHECK_FOR_UPDATES = 7037,
        STR_PLUGIN_MANAGER_TIP = 7038,
    };
} // namespace OpenRCT2
