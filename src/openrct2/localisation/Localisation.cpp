...
static void format_string_code(uint32_t format_code, char** dest, size_t* size, char** args)
{
    ...
    switch (format_code)
    {
        case FORMAT_COMMA32:
            // Pop argument
            memcpy(&value, *args, sizeof(int32_t));
            *args += 4;
        ...
        case FORMAT_COMMA1DP16:
            // Pop argument
            memcpy(&value, *args, sizeof(int16_t));
            *args += 2;
        ...
        case FORMAT_UINT16:
            // Pop argument
            memcpy(&value, *args, sizeof(uint16_t));
            *args += 2;
        ...
        case FORMAT_STRING:
            // Pop argument
            memcpy(&value, *args, sizeof(uintptr_t));
        ...
        case FORMAT_SPRITE:
            // Pop argument
            memcpy(&value, *args, sizeof(uint32_t));
            *args += 4;
