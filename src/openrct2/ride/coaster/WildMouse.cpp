    ...
    const rct_tile_element * tileElement)
{
    ...
    if (trackSequence == 0 || trackSequence == 3)
    {
        ...
        sub_98196C(session, sbb->sprite_id | session->TrackColours[SCHEME_TRACK], (sint8) sbb->offset.x,
                   (sint8) sbb->offset.y, sbb->bb_size.x, sbb->bb_size.y, (sint8) sbb->bb_size.z,
                   height + (sint8) sbb->offset.z);
    }
