                                       ...
                                       LocationXYZ16 offset, LocationXYZ16 bbOffset, LocationXYZ16 bbSize)
{
    ...
    sub_98199C(session, vehicleImageId | imageColourFlags, (sint8) offset.x, (sint8) offset.y, bbSize.x, bbSize.y, 127,
    ...
    if (dpi->zoom_level <= 1 && (ride->lifecycle_flags & RIDE_LIFECYCLE_ON_TRACK))
    {
        ...
        if (vehicle != nullptr)
        {
            ...
            for (uint8 peepIndex = 0; peepIndex < vehicle->num_peeps; peepIndex += 2)
            {
                ...
                sub_98199C(session, imageId, (sint8) offset.x, (sint8) offset.y, bbSize.x, bbSize.y, 127, offset.z,
