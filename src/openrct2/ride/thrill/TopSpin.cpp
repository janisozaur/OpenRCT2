    ...
    const rct_tile_element * tileElement)
{
    ...
    sub_98199C(session, image_id, al, cl, lengthX, lengthY, 90, height, boundBoxOffsetX, boundBoxOffsetY,
               boundBoxOffsetZ);
    ...
    if (dpi->zoom_level < 2 && vehicle != nullptr && vehicle->num_peeps != 0)
    {
        ...
        if (vehicle->num_peeps > 2)
        {
            ...
            sub_98199C(session, image_id, (sint8) seatCoords.x, (sint8) seatCoords.y, lengthX, lengthY, 90,
