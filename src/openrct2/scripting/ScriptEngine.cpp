...
ScWallObject Scripting::gScWallObject;
ScFootpathAdditionObject Scripting::gScFootpathAdditionObject;
ScBannerObject Scripting::gScBannerObject;
...
void ScriptEngine::RegisterClasses(JSContext* ctx)
{
    ...
    gScWallObject.Register(ctx);
    gScFootpathAdditionObject.Register(ctx);
    gScBannerObject.Register(ctx);
...
void ScriptEngine::UnregisterClasses()
{
    ...
    gScWallObject.Unregister();
    gScFootpathAdditionObject.Unregister();
    gScBannerObject.Unregister();
